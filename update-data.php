        ...
        <form method="POST">
            ...
            <div class="mb-3">
                <label for="program_studi" class="form-label">Program Studi</label>
                    <select class="form-select" id="program_studi" name="program_studi" value="<?php echo $data['program_studi']; ?>" required>
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                <select class="form-select" id="hasil_quiz" name="hasil_quiz" value="<?php echo $data['hasil_quiz']; ?>" required>
                        <option value="application_developer">application_developer</option>
                        <option value="system_analyst">system_analyst</option>
                        <option value="auditor_it">auditor_it</option>
                </select>
            </div>
            </div>
